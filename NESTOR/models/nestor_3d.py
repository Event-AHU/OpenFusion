...
class AFNOExpert(nn.Module):
    def __init__(self, dim, modes=32, n_blocks=4, act='gelu', double_skip=True, mlp_ratio=1.):
        ...
        self.mlp = nn.Sequential(
            nn.Conv3d(in_channels=dim, out_channels=mlp_hidden_dim, kernel_size=1, stride=1),
            ACTIVATION[act],
            nn.Conv3d(in_channels=mlp_hidden_dim, out_channels=dim, kernel_size=1, stride=1),
        )
