...
name = 'Wave-Gauss'
DATASET_DICT[name] = {
    'train_path': './data/large/Wave-Gauss/train.h5',
    'test_path':  './data/large/Wave-Gauss/test.h5',
    'valid_path': './data/large/Wave-Gauss/valid.h5'
}
DATASET_DICT[name]['train_size'] = 10212
DATASET_DICT[name]['test_size'] = 240
DATASET_DICT[name]['scatter_storage'] = False
DATASET_DICT[name]['t_total'] = 16  
DATASET_DICT[name]['t_in'] = 1       
DATASET_DICT[name]['t_test'] = 15    
...
name = 'Wave-Gauss-c'
DATASET_DICT[name] = {
    'train_path': './data/large/Wave-Gauss/gauss_c/train.h5',
    'test_path':  './data/large/Wave-Gauss/gauss_c/test.h5',
    'valid_path': './data/large/Wave-Gauss/gauss_c/valid.h5'
}
DATASET_DICT[name]['train_size'] = 10212
DATASET_DICT[name]['test_size'] = 240
DATASET_DICT[name]['scatter_storage'] = False
...
DATASET_DICT[name]['in_size'] = (128, 128)
DATASET_DICT[name]['n_channels'] = 4  
DATASET_DICT[name]['pred_channels'] = 1 
DATASET_DICT[name]['mask_channels'] = [1]  
DATASET_DICT[name]['downsample'] = (1, 1)


name = 'Wave-Layer'
DATASET_DICT[name] = {
    'train_path': './data/large/Wave-Layer/train.h5', 
    'test_path':  './data/large/Wave-Layer/test.h5',
    'valid_path': './data/large/Wave-Layer/valid.h5'
}
DATASET_DICT[name]['train_size'] = 10212
DATASET_DICT[name]['test_size'] = 240
DATASET_DICT[name]['scatter_storage'] = False  
...
name = 'Wave-Layer-c'
DATASET_DICT[name] = {
    'train_path': './data/large/Wave-Layer/layer_c/train.h5',
    'test_path':  './data/large/Wave-Layer/layer_c/test.h5',
    'valid_path': './data/large/Wave-Layer/layer_c/valid.h5'
}
DATASET_DICT[name]['train_size'] = 10212
DATASET_DICT[name]['test_size'] = 240
DATASET_DICT[name]['scatter_storage'] = False
...
name = 'EAR5'
DATASET_DICT[name] = {
    'train_path': './data/large/EAR5/train.h5',
    'test_path':  './data/large/EAR5/test.h5',  
}
DATASET_DICT[name]['train_size'] = 1449   
DATASET_DICT[name]['test_size'] = 2905
DATASET_DICT[name]['scatter_storage'] = False
DATASET_DICT[name]['t_total'] = 16    
DATASET_DICT[name]['t_in'] = 6         
DATASET_DICT[name]['t_test'] = 10       
DATASET_DICT[name]['in_size'] = (128, 256)  
DATASET_DICT[name]['n_channels'] = 4     
DATASET_DICT[name]['downsample'] = (1, 1)
