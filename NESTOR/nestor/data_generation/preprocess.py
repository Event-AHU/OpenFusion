...
def preprocess_ns2d(load_path='data/pdearena/NavierStokes-2D',
                    save_path='data/large/pdearena1/ns2d_pda'):
    """
...
def preprocess_ns2d_cond():
    ...
    """
    preprocess_ns2d(
        load_path='data/pdearena/NavierStokes-2D-conditoned',
        save_path='data/large/pdearena1/ns2d_cond_pda'
    )
