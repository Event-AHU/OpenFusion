...
def predict_temperature(checkpoint_path, device, args):
    ...
    #plot_temperature_distribution(x_combined, y_combined, z_combined, T_combined, 'ALL')
...
def get_MAE(checkpoint_path, device, args):
    ...
    if args.model == 'QRes':
        ...
        plot_temperature_distribution(x_combined, y_combined, z_combined, T_combined, f'ALL_{select_time}_{args.model}s')
        plot_temperature_distribution(x_combined, y_combined, z_combined, abs(T_combined-gt_combined), f'abs_{select_time}_{args.model}')
